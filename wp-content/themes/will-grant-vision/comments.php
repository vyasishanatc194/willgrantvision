...
<div class="comments-area" id="comments">
	...
	<?php if ( have_comments() ) : ?>
		...
		<h2 class="comments-title h4 headline <?php echo get_comments_number(); ?>">
	...
	<?php comment_form(array(
		'title_reply' => __( 'Share your thoughts', 'understrap' ),
		'title_reply_before' => '<h3 id="reply-title" class="comment-reply-title h4 headline">'
