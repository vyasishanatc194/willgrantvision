	...
	function understrap_posted_on() {
		...
		$posted_on   = apply_filters(
			'understrap_posted_on', sprintf(
				'<p class="h5 mb-4 pull-right posted-on"><i class="far fa-clock"></i> <a href="%2$s" rel="bookmark">%3$s</a></p>',
		...
		$byline      = apply_filters(
			'understrap_posted_by', sprintf(
				'<p class="h5 mb-4 pull-left byline"><i class="fas fa-user"></i> %1$s<a class="font-weight-bold url fn n" href="%2$s"> %3$s</a></p>',
